...
class login_system:
    ...
    # Create Widgets
        ...
        self.bg1_icon=ImageTk.PhotoImage(file=r"D:\cyber bullying1\cyber bullying\L.jpg")

        self.bg_icon=ImageTk.PhotoImage(file=r"D:\cyber bullying1\cyber bullying\L.jpg")
        self.user_icon=ImageTk.PhotoImage(file=r"D:\cyber bullying1\cyber bullying\u1.png")
        self.pass_icon=ImageTk.PhotoImage(file=r"D:\cyber bullying1\cyber bullying\p1.jpg")
